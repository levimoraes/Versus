...
- (void)viewDidLoad
{
    NSString *music = [[NSBundle mainBundle]pathForResource:@"music2" ofType:@"m4a"];
    audioPlayer3 = [[AVAudioPlayer alloc]initWithContentsOfURL:[NSURL fileURLWithPath:music] error:NULL];
